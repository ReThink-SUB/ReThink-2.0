      ...
      <div className="green-box">
        <div className="bottom-row">
          <div className="reason-col">
            ...
            <CreateReasonBox reasonNumber="1" reasonHeading="Build Trust & Integrity" reasonDescription="Become certified in our community as a sustainable business!"/>
          ...
          <div className="join-col">
            ...
            <button onClick={() => window.open(FORM_URL, "_blank")}>Sign Up</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="reason-box">
      <div className="reason-box-row">
        ...
        <div className="reason-box-column">
          <p className="reason-box-heading">{props.reasonHeading}</p>
